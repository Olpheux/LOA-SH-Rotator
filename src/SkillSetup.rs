...
pub fn SkillSetup(attack_power: f64) -> Vec<Skill> {
    let mut ruining_rush = Skill{
...
pub fn calcModifiedSkills(
    ...
    let mut skills = SkillSetup(attack_power);
